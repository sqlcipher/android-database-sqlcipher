...
The latest binary packages for developers, with the jar’s, .so’s and a quick sample can be [[http://sqlcipher.net/storage/android/downloads/SQLCipher%20for%20Android%202.1.1.zip][here]], the source can be found [[https://github.com/sqlcipher/android-database-sqlcipher][here]].
